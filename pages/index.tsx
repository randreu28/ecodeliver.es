...
export default function Example() {
  ...
  const locale = useRouter().locale as "en" | "es";
  const footerTranslations = i18nFooter[locale];
  const splashScreenTranslations = i18nSplashScreen[locale];
  ...
  return (
    <>
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">ecoDeliver</span>
      ...
      <div className="px-6 pt-14 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-primary to-[#26ff00] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56 min-h-screen">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              {splashScreenTranslations.heroTitle1} {locale === "en" && <br />}
              <TextTransition
                inline={true}
              ...
              {splashScreenTranslations.heroTitle2}
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto">
              {splashScreenTranslations.description}
            </p>
          </div>
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-primary to-[#26ff00] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
      ...
      <footer className="container pt-5 pb-2 mx-auto space-y-2">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 justify-items-center">
              ...
              <div>
                ...
                <Link
                  ...
                  className="block mt-2 text-gray-600  hover:underline"
                >
                  {footerTranslations.brandIdentity}
                </Link>
                <Link
                  href="/compromisos"
                  className="block mt-2 text-gray-600  hover:underline"
                >
                  {footerTranslations.compromises}
                </Link>
              </div>

              <div>
                <h3 className="text-gray-700 font-semibold text-lg">
                  {footerTranslations.contactUs}
                </h3>
                <a
                  href="mailto:hola@ecodeliver.tech"
                  className="block mt-2 text-gray-600 hover:underline"
                >
                  {footerTranslations.workWithUs}
                </a>
                <a
                  href="mailto:hola@ecodeliver.tech"
                  className="block mt-2 text-gray-600 hover:underline"
        ...
        <p className="text-center text-gray-500">
          © ecoDeliver 2023 - All rights reserved
        </p>
      </footer>
    </>
  );
